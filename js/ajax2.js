...
function alererter(result, message, notfade)
{
	...
	{
		if (result == 1)
			var messageshow = '<div class="alert_success"><span><img src="' + TWSHsiteurl + 'templates/' + TWSHtemplate + '/images/correct.png" width="20"/> </span> ' + message + '</div>';
		else if (result == 0)
			var messageshow = '<div class="alert_error"><span><img src="' + TWSHsiteurl + 'templates/' + TWSHtemplate + '/images/delete.png" width="20"/> </span> ' + message + '</div>';
		else if (result == 2)
